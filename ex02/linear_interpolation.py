...
if __name__ == '__main__':
    ...
    linear_interpolation(Matrix([[1, 2, 3], [1, 4, 3], [1, 2, 6]]), Matrix([[1, 2, 3], [2, 5, 5], [10, 4, 10]]), 0)
    linear_interpolation(Matrix([[1, 2, 3], [1, 4, 3], [1, 2, 6]]), Matrix([[1, 2, 3], [2, 5, 5], [10, 4, 10]]), 0.5)
    linear_interpolation(Matrix([[1, 2, 3], [1, 4, 3], [1, 2, 6]]), Matrix([[1, 2, 3], [2, 5, 5], [10, 4, 10]]), 1)
    linear_interpolation(Matrix([[1, 1, 1], [1, 1, 1], [1, 1, 1]]), Matrix([[11, 11, 11], [101, 101, 101], [4, 5, 6]]), 0.4)