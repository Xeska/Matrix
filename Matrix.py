...
class Matrix():
    ...
    def determinant(self):
        ...
        if (size == 1):
            ...
            subMatrix_1 = Matrix([[f, g, h], [j, k, l], [n, o, p]])
            subMatrix_2 = Matrix([[e, g, h], [i, k, l], [m, o, p]])
            subMatrix_3 = Matrix([[e, f, h], [i, j, l], [m, n, p]])
            subMatrix_4 = Matrix([[e, f, g], [i, j, k], [m, n, o]])

            return a * subMatrix_1.determinant() - b * subMatrix_2.determinant() + c * subMatrix_3.determinant() - d * subMatrix_4.determinant()
        else:
